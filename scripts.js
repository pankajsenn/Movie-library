...
const titleInput = document.getElementById('title');
  ...
  function select(){
    let selectedvalue = document.getElementById('Searchby').value;
  ...
  document.getElementById('search').addEventListener('click', function(event){
    ...
    if(selectedvalue === "title"){
      ...
      alert("please provide valid movie title");
    }
    }
      ...
      alert("please provide valid genre");
    }
    }
    else if(selectedvalue === "both"){
        if(genreInput.value && titleInput.value){
        searchResults = searchBoth(titleInput.value,genreInput.value);
        if(searchResults.length === 0){
          ...
          alert("please provide both movie name and genre");
        }
    }
    else{
      alert("please select and type the name of moviee");
    }
  });
  ...
  function countByGenre(list){
    let countObject = {};
    document.getElementById("movie-count").innerHTML= `<h2>The count of movies</h2>`
    list.map(item => {
